...
L.Control.OHMTimeSlider.Translations['es'] = {
    ...
    daterange_min_month_title: "Selecciona en que mes debe comenzar la barra cronol—gica",
    daterange_min_day_title: "Selecciona en que d’a debe comenzar la barra cronol—gica",
    daterange_min_year_title: "Selecciona en que a–o debe comenzar la barra cronol—gica",
    daterange_max_month_title: "Selecciona en que mes debe terminar la barra cronol—gica",
    daterange_max_day_title: "Selecciona en que d’a debe terminar la barra cronol—gica",
    daterange_max_year_title: "Selecciona en que a–o debe terminar la barra cronol—gica",
    daterange_submit_text: "Aplicar",
    daterange_submit_title: "Aplicar la configuraci—n",
    ...
    stepamount_1day: "1 d’a",
    stepamount_1month: "1 mes",
    stepamount_1year: "1 a–o",
    stepamount_10year: "10 a–os",
    stepamount_100year: "100 a–os",
    stepinterval_title: "Velocidad de reproducci—n",
    ...
    autoplay_submit_title: "Aplicar la configuraci—n",
